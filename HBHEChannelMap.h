#ifndef CondFormats_HcalObjects_HBHEChannelMap_h_
#define CondFormats_HcalObjects_HBHEChannelMap_h_
...
private:
    ...
    {
    public:
        inline HBHEChannelId() : depth_(1000U) {}
...
#endif // CondFormats_HcalObjects_HBHEChannelMap_h_
